In this project I have used Clalifonia housing dataset, where I given a few questions to solve. I used python libraries like matplotlib, seaborn,pandas,numpy.
